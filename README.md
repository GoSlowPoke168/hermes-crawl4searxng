...
> Note: As of 7/17/26, the upstream Docker image for Crawl4AI arm64 is currently bloated with massive .core dumps and other random stuff, causing the current image to be a whopping 10GB 💀. Update (7/22/26): A PR has been made to fix this issue, making the final size of Crawl4AI ~7GB.
